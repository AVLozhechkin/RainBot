...
{
    public static string BuildNotificationMessage(IReadOnlyList<WeatherRecord> records, string languageCode = "ru")
    {
    ...
    private static string BuildMessageForSameConditions(IReadOnlyList<WeatherRecord> records, string languageCode = "ru")
    {
        Guard.IsNotNull(records);
    ...
    private static string BuildMessageForDifferentConditions(IReadOnlyList<WeatherRecord> records, string languageCode = "ru")
    {
        Guard.IsNotNull(records);
    ...
    private static string BuildMessageForSingleRecord(WeatherRecord record, string languageCode = "ru")
    {
